...
schema_view = get_schema_view(
    openapi.Info(
        title="aziz-g Apartments API",
        default_version="v1",
        description="An Apartment Management API for Real Estate",
        contact=openapi.Contact(email="abdulazizalgharbi8@gmail.com"),
...
admin.site.site_title = "aziz-g Apartments Admin Portal"
admin.site.index_title = "Welcome to aziz-g Apartment Admin Portal"
