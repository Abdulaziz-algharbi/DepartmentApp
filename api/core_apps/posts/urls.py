...
from .views import (BookmarkedPostListAPIView, UnBookmarkPostAPIView, BookmarkPostAPIView, PostListAPIView, PostCreateAPIView,
                    PostDetailAPIView, PostUpdateAPIView, ReplyListAPIView, ReplyCreateAPIView, UpvotePostAPIView, DownvotePostAPIView, MyPostListAPIView, PopularTagsListAPIView, TopPostsListAPIView, PostsByTagListAPIView)
...
urlpatterns = [
    ...
    path("<slug:slug>/bookmark/",
         BookmarkPostAPIView.as_view(), name="bookmark-post"),
    path("<slug:slug>/unbookmark/",
         UnBookmarkPostAPIView.as_view(), name="unbookmark-post"),
    path("bookmarked/posts/", BookmarkedPostListAPIView.as_view(),
    ...
    path("<uuid:post_id>/downvote/",
         DownvotePostAPIView.as_view(), name="downvote-post")
]
