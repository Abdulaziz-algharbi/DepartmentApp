...
from .serializers import (DownvotePostSerializer, PopularTagSerializer, PostSerializer,
                          ReplySerializer, TopPostSerializer, UpvotePostSerializer, PostByTagSerializer)
...
class DownvotePostAPIView(APIView):
    def patch(self, request, post_id):
        ...
        serializer = DownvotePostSerializer(
            post, data={}, context={"request": request})
        if serializer.is_valid():
            serializer.save()
            return Response(
