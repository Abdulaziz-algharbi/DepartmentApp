...
class TopPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ["id", "title", "slug", "author_username", "upvotes",
                  "view_count", "replies_count", "avatar", "created_at"]
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reply
        fields = [
            "id", "post", "author_username", "body", "avatar", "created_at", "updated_at"
        ]
        read_only_fields = [
            "id", "author_username", "created_at", "updated_at"
        ]
...
class BasePostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ["id", "title", "slug", "author_username", "is_bookmarked", "created_at",
                  "updated_at", "view_count", "upvotes", "downvotes", "is_upvoted", "replies_count", "avatar"]
