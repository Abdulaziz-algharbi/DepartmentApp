...
from .views import ProfileListAPIView, ProfileDetailAPIView, ProfileUpdateAPIView, NonTenantProfileListAPIView, AvatarUploadView
...
urlpatterns = [
    ...
    path("user/avatar/", AvatarUploadView.as_view(), name="avatar-update")
]
