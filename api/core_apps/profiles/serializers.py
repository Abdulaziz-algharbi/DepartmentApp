...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["id", "slug", "first_name", "last_name",
                  "username", "full_name", "gender", "country_of_origin", "city_of_origin", "bio", "occupation", "reputation", "date_joined", "avatar", "apartment", "average_rating"]
    ...
    def get_apartment(self, obj: Profile) -> None:
        apartment = obj.user.apartments.first()
        if apartment:
...
class UpdateProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ["first_name", "last_name",
                  "username", "gender", "country_of_origin", "city_of_origin", "bio", "occupation", "phone_number"]
