...
class IssueSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Issue
        fields = ["id", "apartment_unit", "reported_by", "assigned_to",
                  "title", "description", "status", "priority", "view_count"]
...
class IssueStatusUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Issue
        fields = [
            "title", "description", "apartment", "reported_by", "status", "resolved_by", "resolved_on"
        ]
