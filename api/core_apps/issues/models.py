...
class Issue(TimeStampedModel):
    ...
    apartment = models.ForeignKey(
        Apartment, on_delete=models.CASCADE, related_name="issues", verbose_name=_("Apartment"))
    ...
    resolved_on = models.DateField(verbose_name=_(
        "Resolved On"), null=True, blank=True)
