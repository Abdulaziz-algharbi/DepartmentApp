...
from .views import IssueListAPIView, IssueCreateAPIView, IssueDeleteAPIView, IssueUpdateAPIView, MyIssuesListAPIView, IssueDetailAPIView, AssignedIssuesListView
...
urlpatterns = [
    ...
    path("create/<uuid:apartment_id>/",
         IssueCreateAPIView.as_view(), name="create-issue"),
