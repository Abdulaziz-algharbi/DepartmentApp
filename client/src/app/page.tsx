...
export const metadata: Metadata = {
	title: "Home | AzizG Apartments",
	description:
		"AzizG Apartments Home Page. Create your account to get started.",
};
			...
			<main className="flex-center relative z-10 h-full bg-black/50">
				<div className="text-center">
					<h1 className="font-robotoSlab mb-4 text-4xl font-semibold text-cyan-400 antialiased sm:text-6xl md:text-8xl">
						Welcome to AzizG Apartments
					</h1>
					<p className="my-8 text-2xl text-teal-300 sm:text-4xl">
						Are you a tenant? Or an existing tenant?
					</p>
					<Link href="/register" prefetch={false}>
						<button className="bg-asparagus cursor-pointer rounded-3xl px-4 py-2 text-lg font-semibold text-white hover:bg-lime-700 sm:px-6 sm:text-2xl">
